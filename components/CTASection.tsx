      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 animate-scale-in">
            ...
            {/* Custom Amount Input */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Miqdor kiritish (UZS)</label>
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-white">
              ...
              <div className="text-yellow-100">Shaffoflik</div>
            </div>
            <div className="text-white">
              <div className="text-3xl font-bold mb-2">24/7</div>
              <div className="text-yellow-100">Mavjud yordam</div>
            </div>
            <div className="text-white">
              <div className="text-3xl font-bold mb-2">15,200+</div>
              <div className="text-yellow-100">Oilalar yordam oldi</div>
            </div>
          </div>
        </div>
      </div>
